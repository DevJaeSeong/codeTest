...
public interface Solution {
	 ...
	 * <p>
	 * 입출력 예 #3 <br>
	 * 첫 번째 전화번호, “12”가 두 번째 전화번호 “123”의 접두사입니다. <br>
	 * 따라서 답은 false입니다.
	 * </p>
	 * 
	 * <hr>
	 * 
	 * @param phone_book 전화번호가 담긴 배멸
	 * @return <i>false</i> - 어떤 번호가 다른 번호의 접두어인 경우가 있으면 <br>
	 * 		   <i>true</i> - 그렇지 않다면
	 * @see https://school.programmers.co.kr/learn/courses/30/lessons/42577?language=java
	 */
